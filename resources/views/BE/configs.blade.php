                ...
                <div class="col-lg-12">
                    <div class="form-panel">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" value="" name="name" class="form-control" placeholder="Nhập tên Website">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" value="" name="address" class="form-control" placeholder="Nhập địa chỉ">
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="form-panel">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" value="" name="facebook" class="form-control" placeholder="Facebook">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" value="" name="youtube" class="form-control" placeholder="Youtube">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" value="" name="instagram" class="form-control" placeholder="Instagram">
                            </div>
                        </div>
