<section class="banner-4" @if(!empty($web['big_banner_image'])) style="background-image: url({{ asset('storage/' . $web['big_banner_image']) }})" @endif>
    <div class="container">
        <div class="row">
            <div class="col-xl-7 col-lg-12">
                <h2>{{ $web['big_banner_title'] ?? 'We Create Powerful & Simple Architecture Solutions' }}</h2>
